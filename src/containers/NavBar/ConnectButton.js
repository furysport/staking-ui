...
const ConnectButton = (props) => {
    ...
    return (
        <button
        className="inline-flex items-center px-6 py-1.5 text-base font-bold text-white rounded-full shadow-sm disabled:opacity-80 hover:opacity-95 bg-gradient-to-r from-423da1 via-20bdff to-A5FECB focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            disabled={inProgress}
            variant="contained"
            onClick={initKeplr}
        >
